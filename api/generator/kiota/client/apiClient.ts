...
// @ts-ignore
import { PetsRequestBuilderNavigationMetadata, PetsRequestBuilderRequestsMetadata, type PetsRequestBuilder } from './pets/';
// @ts-ignore
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    pets: {
        requestsMetadata: PetsRequestBuilderRequestsMetadata,
        navigationMetadata: PetsRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
